...
FW1_NAME="${YL}[2026]${NC} DOTYWRT REV 1.0 • ${GR}PAID${NC}"
FW1_ID="0f551c9f2d9e0f57d59a843bf48ca202494927a6cef47003"

FW2_NAME="${YL}[2025]${NC} DOTYLITE QM 1.4 • ${RD}FREE${NC}"
FW2_ID="36225ff611df1db14aa6edc784d66d8563ca075d18ecc8da"

FW3_NAME="${YL}[2025]${NC} DOTYLITE QM 1.3 • ${RD}FREE${NC}"
FW3_ID="31bd4fcbf9d6d984d4d3c2b7aa7be5614d65df6ca071dacd"
